...
const TABLAS_PERMITIDAS = ['trabajadores', 'asistencias', 'evaluaciones_psicometricas', 'movimientos_trabajador', 'vacaciones_programadas', 'checadores', 'repse_proveedores', 'repse_docs_mensuales', 'repse_invitaciones'];
