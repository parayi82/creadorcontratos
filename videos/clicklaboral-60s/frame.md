...
colors:
  ...
  text-muted: "#005AC8"
  text-light: "#9A9A9A"
  accent-light: "rgba(0, 90, 200, 0.08)"
  accent-medium: "rgba(0, 90, 200, 0.15)"
  border: "rgba(0, 90, 200, 0.2)"
  card-bg: "rgba(0, 90, 200, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Plus Jakarta Sans** (display) / **Plus Jakarta Sans** (body); ignore any preset font name lingering in prose.
...
```html
<style>
@font-face{font-family:"Plus Jakarta Sans";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/PlusJakartaSans-400.woff2") format("woff2");}
@font-face{font-family:"Plus Jakarta Sans";font-weight:500;font-style:normal;font-display:block;src:url("assets/fonts/PlusJakartaSans-500.woff2") format("woff2");}
@font-face{font-family:"Plus Jakarta Sans";font-weight:600;font-style:normal;font-display:block;src:url("assets/fonts/PlusJakartaSans-600.woff2") format("woff2");}
@font-face{font-family:"Plus Jakarta Sans";font-weight:700;font-style:normal;font-display:block;src:url("assets/fonts/PlusJakartaSans-700.woff2") format("woff2");}
</style>
```
